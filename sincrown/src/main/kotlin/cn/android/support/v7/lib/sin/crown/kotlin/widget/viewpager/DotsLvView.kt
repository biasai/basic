...
class DotsLvView : BaseView {
    ...
    fun defaultColor(defaultColor: Int = this.defaultColor): DotsLvView {
    ...
    fun selectColor(selectColor: Int = this.selectColor): DotsLvView {
        this.selectColor = selectColor
        return this
    }

    var radius = ProportionUtils.getInstance().adapterInt(15 / 2)//圆点半径
    fun radius(radius: Int = this.radius): DotsLvView {
        this.radius = radius
        return this
    }

    var offset = ProportionUtils.getInstance().adapterInt(30)//圆点之间的间隙
    fun offset(offset: Int = this.offset): DotsLvView {
        this.offset = offset
        return this
    }
    ...
    fun viewPager(viewPager: ViewPager?): DotsLvView {
    ...
    fun selectPosition(selectPosition: Int = this.selectPosition): DotsLvView {
