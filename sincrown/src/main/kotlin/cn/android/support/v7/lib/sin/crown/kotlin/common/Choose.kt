...
//                topMargin = px.x(24)
//            })
class Choose(var isMulti: Boolean = false, var minMulti: Int = 0) {
    ...
    //获取多选
    fun getChekViews(): ArrayList<View> {
        if (chekViews.size <= 0) {
